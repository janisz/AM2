...
\footnotetext[1]{ to znaczy $\exists M\in\mathbb{R} ~~ \forall n\in\mathbb{N} \quad |b_1 + b_2 + \dots b_n| \leqslant M$}
\end{tw}
...
\begin{df}[Zbiezności ciągu o wyrazach w przestrzeni metrycznej]~\\
...
\begin{df}
Ciąg $(a_n)$ o wyrazach w przestrzeni metrycznej spelnia warunek Cauch'ego $\Leftrightarrow \forall \varepsilon >0 ~~ \exists N ~ \forall n,m > N \quad \rho(a_n, a_m) < \varepsilon$
\end{df}
